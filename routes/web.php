...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::get('/api/settings', [AdminSettingsController::class, 'show'])->name('api.settings.show');
        Route::put('/api/settings', [AdminSettingsController::class, 'update'])->name('api.settings.update');
